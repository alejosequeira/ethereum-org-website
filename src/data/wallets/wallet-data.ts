...
export const walletsData: WalletData[] = [
  {
    ...
    non_custodial: true,
    privacy_resistance: true,
    device_access_protection: true,
    unauthorized_dapp_blocking: true,
    intended_action_verification: true,
    malicious_dapp_blocking: true,
    interaction_safeguards: true,
    audit_reports_published: true,
    security_audit: [
